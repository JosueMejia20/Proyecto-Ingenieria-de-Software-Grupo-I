                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="admisionesDropdown">
                            ...
                            <li><a class="dropdown-item" href="/revisor/solicitud">Revisores</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="d-flex">
                    <!--<a href="#" class="btn btn-unah-primary me-2">Ingresar</a>
                    <a href="#" class="btn btn-unah-secondary">Registrarse</a>-->
                </div>
            </div>
        </div>
    </nav>